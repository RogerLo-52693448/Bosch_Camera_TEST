...
使用 TCP 傳輸避免 UDP 丟包造成 H.264 解碼錯誤。
"""
...
# ============================================================
# StreamBuffer - RTSP 環形緩衝區 (TCP 傳輸)
# ============================================================
class StreamBuffer:
    ...
    def _capture_loop(self):
        ...
        while self.running and not self.stop_event.is_set():
            try:
                # 強制使用 TCP 傳輸，避免 UDP 丟包導致 H.264 解碼錯誤
                ...
                print(f"  📹 RTSP 連線成功 (TCP) | FPS: {self.fps:.1f} | 緩衝: {self.buffer_seconds}s")
                retry_count = 0
...
class MQTTCaptureService:
    ...
    def _trigger_capture(self):
        ...
        for offset in offsets_ms:
            ...
            filename = f"{timestamp_prefix}_{offset_label}.jpg"
